...
??? note "Text version"
    ...
    **Purdue University** — West Lafayette, IN · B.S. Computer Science, Machine
    ...
    - **Certificate:** Applications in Data Science. **Coursework:** Analysis of
      Algorithms, Data Mining &amp; Machine Learning, Intro to Artificial Intelligence,
    ...
    **Software Engineering Intern** — Stealth Startup · Remote · Nov 2024 – Aug 2025
    ...
    - Designed a meal planner and recipe book that renders personalized meal plans in
      a calendar view from user preferences.
    - Built the frontend in Next.js and the backend on TypeScript Supabase Edge
      Functions, with Google OAuth for authentication.
    ...
    **Undergraduate Data Science Researcher** — The Data Mine, Purdue University —
    ...
    - Implemented web scraping with BeautifulSoup and Selenium, and trained an NER
      model to categorize manufacturing terminology (Knudsen Institute).
    ...
    **Personal Finance Management App** · Next.js, React, TypeScript, Supabase,
    ...
    - Built a full-stack finance tracker organizing transactions into billing periods,
      with per-card utilization and automatic balance rollover.
    ...
    **Personal Website on AWS** · Terraform, S3, CloudFront, Route 53 · Aug 2024, Jul 2025
    ...
    - Provisioned a responsive personal website entirely through infrastructure as
      code: S3 hosting, CloudFront for security and content delivery, Route 53 for DNS.
    ...
    **HarvardX Data Science Projects** · R, Machine Learning · Summer 2023
    ...
    - Built two capstone projects applying machine learning and visualizations in R to
      rank films and car brands against one another.

    #### Technical Skills

    - **Languages:** Python, JavaScript, TypeScript, Java, C/C++, R, SQL, HTML5/CSS, Unix Shell
    - **Frameworks &amp; Libraries:** React, Next.js, Flask, Supabase, Firebase, PostgreSQL, BeautifulSoup, Selenium, Maestro, Appium
    - **DevOps &amp; Cloud:** AWS (S3, CloudFront, Route 53, Amplify), Terraform (IaC), Docker, Git/GitHub, Agile Development
    - **AI Tools &amp; APIs:** Cursor, Claude, ChatGPT, Claude API (tool calling, web search), Gemini API, GPT-4.1-mini, ElevenLabs
